...
var delete_recipe_controller_exports = {};
__export(delete_recipe_controller_exports, {
  DeleteRecipeController: () => DeleteRecipeController
});
module.exports = __toCommonJS(delete_recipe_controller_exports);
...
var DeleteRecipeController = class {
  async handle(request, response) {
    const deleteRecipeUseCase = import_tsyringe2.container.resolve(DeleteRecipeUseCase);
